...
const categories = [
  ...
  { title: "Dholera Estate 3", description: "Dholera Estate 3 by Omana Projects — verified residential plots near Dholera SIR. Transparent documentation, expert guidance and secure investment opportunities.", icon: FaTruckFast, accent: "#960aaa", soft: "#f6eaff", position: "object-center", image: "/images/dholera-estate-3-project.png" },
];
